...
namespace Dalssoft.DiagramNet
{
	...
	internal class DiagramUtil
	{
        ...
        //Recibe las coordenadas de un punto y nos devuelve su ángulo respecto de los ejes coordendos
        ...
        //Obtiene la dirección Norte, Sur, Este o Oeste
        ...
        public static Point RoundPoint(Point pt, Size rasterSize)
        {
            return new Point((int)(Math.Round((float)pt.X / rasterSize.Width) * rasterSize.Width),
                (int)(Math.Round((float)pt.Y / rasterSize.Height) * rasterSize.Height));
        }

        public static Size RoundSize(Size size, Size rasterSize)
        {
            return new Size((int)(Math.Round((float)size.Width / rasterSize.Width) * rasterSize.Width),
                (int)(Math.Round((float)size.Height / rasterSize.Height) * rasterSize.Height));
        }
		#endregion
