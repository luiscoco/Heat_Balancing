...
namespace Dalssoft.DiagramNet
{
	...
	public class ConnectorElement: RectangleElement, IControllable 
	{
		...
		public ElementCollection links = new ElementCollection();

        public int linkNumber;
        public string linkType; //Input or Output
        
        public string ConnectorElementName; 
        public Color ConnectorColor = new Color();
