...
{
    [Serializable]
    public class TurbineWithoutExhaustLossesNode : NodeElement, IControllable, ILabelElement
    {
        public TurbineWithoutExhaustLossesElement turbina;
        ...
        public TurbineWithoutExhaustLossesNode(Rectangle rec, int tipoelemento2, Image imagen2, Double NumEquipo) : this(rec.Location, rec.Size, tipoelemento2, imagen2, NumEquipo)
        {

        }

        public TurbineWithoutExhaustLossesNode(Point l, Size s, int tipoelemento2, Image imagen2, Double NumEquipo) : this(l.X, l.Y, s.Width, s.Height, tipoelemento2, imagen2, NumEquipo)
        {

        }

        public TurbineWithoutExhaustLossesNode(int top, int left, int width, int height, int tipoelemento2, Image imagen2, Double NumEquipo) : base(top, left, width, height, tipoelemento2)
        {
            NumEquipo1 = NumEquipo;
            tipoelemento1 = tipoelemento2;
            imagen10 = imagen2;
            connectors12 = base.connects;
            turbina = new TurbineWithoutExhaustLossesElement(top, left, width, height, tipoelemento1, imagen10, NumEquipo1);
            SyncContructors();
        }

        public TurbineWithoutExhaustLossesNode() : this(0, 0, 100, 100, 9, null, 0)
        {
