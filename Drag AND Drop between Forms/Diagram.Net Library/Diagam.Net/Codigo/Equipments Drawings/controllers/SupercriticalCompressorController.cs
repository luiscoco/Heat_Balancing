...
namespace Dalssoft.DiagramNet
{
    ...
    /// </summary>
    internal class SupercriticalCompressorController : RectangleController, IController
    {
        public SupercriticalCompressorController(BaseElement element) : base(element)
        {
        }
