...
namespace Dalssoft.DiagramNet
{
    ...
    /// </summary>
    internal class SupercriticalHeatExchangerController : RectangleController, IController
    {
        public SupercriticalHeatExchangerController(BaseElement element) : base(element)
        {
        }
