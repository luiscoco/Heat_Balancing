...
namespace Dalssoft.DiagramNet
{
	...
	/// </summary>
	internal class TurbinaController: RectangleController, IController
	{
		public TurbinaController(BaseElement element): base(element)
		{
		}
		...
		public override void DrawSelection(System.Drawing.Graphics g)
		{
            ...
            //         puntos[0].X = el.Location.X+10;
            //         puntos[0].Y = el.Location.Y+5+(el.Size.Height / 4);

            //         puntos[1].X = el.Location.X-10+ el.Size.Width;
            //         puntos[1].Y = el.Location.Y+10;

            //         puntos[2].X = el.Location.X+ el.Size.Width-10;
            //         puntos[2].Y = el.Location.Y+ el.Size.Height-10;

            //         puntos[3].X = el.Location.X+10;
            //         puntos[3].Y = el.Location.Y-5 +(3 * el.Size.Height / 4);
