...
namespace Dalssoft.DiagramNet
{
    ...
    /// </summary>
    internal class TurbineWithoutExhaustLossesController : RectangleController, IController
    {
        public TurbineWithoutExhaustLossesController(BaseElement element) : base(element)
        {
        }
