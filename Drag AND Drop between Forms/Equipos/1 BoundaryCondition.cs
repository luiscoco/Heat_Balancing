...
namespace Drag_AND_Drop_between_Forms
{
    public partial class Condcontorno : Form
    {
        ...
        public void funcionauxiliar()
        {
            ...
            listBox1.Items.Add("Equipment Number:" + Convert.ToString(numequipo));
            listBox1.Items.Add("Equipment Type: Boundary Condition (Type 1)");
        ...
        private List<String> generaecucaiones(Double D1, Double D2,Double D3, Double D5, Double D6, Double D7, Double correntrada, Double corrsalida)
        {
            ...
            if (checkBox1.Checked == false)
            {
                ...
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "Generated 3 equations for mass flow, pressure and enthalpy continuity:";
                    auxiliar++;

                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada) + " - " + "W" + Convert.ToString(corrsalida) + " = 0";
                    auxiliar++;
                }
                else
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "Generated 2 equations for pressure and enthalpy continuity:";
                    auxiliar++;
                }

                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada) + " - " + "P" + Convert.ToString(corrsalida) + " = 0";
                auxiliar++;

                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada) + " - " + "H" + Convert.ToString(corrsalida) + " = 0";
                auxiliar++;

                //ecuaciones2.Add("");
                //ecuaciones2[auxiliar] = "";
                //auxiliar++;

                ecuaciones2.Add("");
                ecuaciones2[auxiliar] = "Generated 3 equations for mass flow, pressure and enthalpy user-input conditions:";
                auxiliar++;

                if (D1 > 0)
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "W" + Convert.ToString(correntrada) + " - " + Convert.ToString(D1) + " = 0";
                    auxiliar++;
                }
                ...
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "P" + Convert.ToString(correntrada) + " - " + Convert.ToString(D2) + " = 0";
                    auxiliar++;
                }
                ...
                {
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada) + " - " + Convert.ToString(D3) + " = 0";
                    auxiliar++;
                }
                ...
                else if (D6 > 0 && D3 == 0)
                {
                    ...
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada) + " - " + "hpx(" + Convert.ToString(D6) + "," + Convert.ToString(D7) + ")" + " = 0";
                    auxiliar++;
                }
                ...
                else if (D6 < 0 && D3 == 0)
                {
                    ...
                    ecuaciones2.Add("");
                    ecuaciones2[auxiliar] = "H" + Convert.ToString(correntrada) + " - " + "htx(" + Convert.ToString(-D6) + "," + Convert.ToString(D7) + ")" + " = 0";
                    auxiliar++;
                }
