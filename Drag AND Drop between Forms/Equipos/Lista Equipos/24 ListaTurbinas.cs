...
{
    public partial class ListaTurbinas24 : Form
    {
        Aplicacion puntero1;

        public ListaTurbinas24(Aplicacion puntero)
        {
            puntero1 = puntero;
        ...
        private void ListaTurbinas24_Load(object sender, EventArgs e)
        {
            LeerEquipos();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Turbina24 turbina24 = new Turbina24(puntero1, puntero1.numecuaciones, puntero1.numvariables,0,0);
            if (turbina24.ShowDialog(this) == System.Windows.Forms.DialogResult.OK)
            {
               listBox1.Items.Add("Equipo Nº: "+Convert.ToString(puntero1.equipos11[puntero1.numequipos-1].numequipo2)+"   Tipo Equipo: " +Convert.ToString(24));
            }            
        }
        ...
        private void LeerEquipos()
        {
            for (int i = 0; i <puntero1.equipos11.Count; i++)
            {
                ...
                if (puntero1.equipos11[i].tipoequipo2 == 24)
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Turbina24 turb24=new Turbina24(puntero1, puntero1.numecuaciones, puntero1.numvariables,1,indice);
            ...
            {
                turb24.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                //Presión  psia a Bar
                turb24.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aD2 * (6.8947572 / 100));                   
            }
            ...
            else if (puntero1.unidades == 0)
            {
                turb24.textBox1.Text = Convert.ToString(puntero1.equipos11[indice].aD1);
                //Presión psia
                turb24.textBox10.Text = Convert.ToString(puntero1.equipos11[indice].aD2);
            }

            turb24.textBox7.Text=Convert.ToString(puntero1.equipos11[indice].aN1);
            turb24.textBox8.Text = Convert.ToString(puntero1.equipos11[indice].aN3);
            turb24.textBox9.Text = Convert.ToString(puntero1.equipos11[indice].numequipo2);
