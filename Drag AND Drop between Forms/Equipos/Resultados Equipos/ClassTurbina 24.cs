...
namespace ClaseEquipos
{
    ...
    //IMPORTANTE: Esta clase es erronea para el cálculo de las TEMPERATURAS a partir de las presiones y entalpías. 
    //Habría que reimplementarla para no utilizar las Tablas Agua-Vapor de 1967, sino la base de datos REFPROP para fluidos supercríticos.
    //Para llamar a las funciones de REFPROP del fluido elegido: puntero1.luis1.working_fluid.FindStatueWithPH(P,H)

    public class ClassTurbina24
    {
        Aplicacion puntero1;
        ...
        //Constructor
        public ClassTurbina24(Aplicacion puntero)
        {
            puntero1 = puntero;            
        }
