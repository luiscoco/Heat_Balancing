        ...
        public void button5_Click(object sender, EventArgs e)
        {
            ...
            //Bucle que lee todos los caracteres en la LINEA 1 del archivo leido
                ...
                for (int a=2;a<=(int)(2*numeroequipos);a=a+2)
                {
                    ...
                    //Creamos las ecuaciones correspondientes al Intercambiador (Equipo Tipo 23)
                    else if (tipoequipo == 23)
                    {
                        Intercambiador Intercambiador1 = new Intercambiador(puntero1, puntero1.numecuaciones, puntero1.numvariables, 0, 0);
                        Intercambiador1.numequipo = numequipo;
                        Intercambiador1.D1 = D[0];
                    ...
                    //Creamos las ecuaciones correspondientes a la Turbina supercritica (Equipo Tipo 24)
                    else if (tipoequipo == 24)
                    {
                        Turbina24 turbina24 = new Turbina24(puntero1, puntero1.numecuaciones, puntero1.numvariables, 0, 0);
                        turbina24.numequipo = numequipo;
                        turbina24.D1 = D[0];
                        turbina24.D2 = D[1];
                        turbina24.D3 = D[2];
                        turbina24.D5 = D[4];
                        turbina24.D8 = D[7];
                        turbina24.correntrada = N1;
                        turbina24.corrsalida = N3;
                        turbina24.funcionauxiliar();
                        turbina24.funcionauxiliar1();

                        listacorrsalida[corrientesdesalida] = N3;
                        corrientesdesalida++;
                    }

                //Creamos las ecuaciones correspondientes a la Compresor Supercritico (Equipo Tipo 25)
                else if (tipoequipo == 25)
                {
                    Compresor25 cmpresor25 = new Compresor25(puntero1, puntero1.numecuaciones, puntero1.numvariables, 0, 0);
                    cmpresor25.numequipo = numequipo;
                    cmpresor25.D1 = D[0];
                    cmpresor25.D2 = D[1];
                    cmpresor25.D3 = D[2];
                    cmpresor25.D5 = D[4];
                    cmpresor25.D8 = D[7];
                    cmpresor25.correntrada = N1;
                    cmpresor25.corrsalida = N3;
                    cmpresor25.funcionauxiliar();
                    cmpresor25.funcionauxiliar1();
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        private void LecturaHbal_Load(object sender, EventArgs e)
        {
            if (fl != null)
            {
                ...
                {
                    puntero1.textBox14.Add(lineas11[i]);
                }

                listBox1.Items.Add("Número de líneas del archivo:" + Convert.ToString(numlineasfichero - 1));
                puntero1.textBox14.Add("Número de líneas del archivo:" + Convert.ToString(numlineasfichero - 1));
